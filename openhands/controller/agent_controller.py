...
class AgentController:
    ...
    def _reset(self) -> None:
        ...
        if self._pending_action and hasattr(self._pending_action, 'tool_call_metadata'):
            ...
            if not found_observation:
                ...
                self.event_stream.add_event(obs, EventSource.AGENT, parent_event=self._pending_action, method="error_observation")
    ...
    async def set_agent_state_to(self, new_state: AgentState) -> None:
        ...
        if new_state in (AgentState.STOPPED, AgentState.ERROR):
            ...
            self.event_stream.add_event(self._pending_action, EventSource.AGENT, parent_event=event, method="agent_action")
    ...
    def end_delegate(self) -> None:
        ...
        if delegate_state in (AgentState.FINISHED, AgentState.REJECTED):
            ...
            self.event_stream.add_event(obs, EventSource.AGENT, parent_event=self.delegate._pending_action, method="delegate_success")
        else:
            ...
            # emit the delegate result observation
            obs = AgentDelegateObservation(outputs=delegate_outputs, content=content)
            self.event_stream.add_event(obs, EventSource.AGENT, parent_event=self.delegate._pending_action, method="delegate_error")
